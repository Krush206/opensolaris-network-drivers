typedef unsigned char	LM_UINT8;
typedef unsigned short	LM_UINT16;
typedef unsigned int	LM_UINT32;
...
#define PCI_INT_INTA	0x01	/* PCI INTA# is asserted */
#define PCI_INT_INTB	0x02	/* PCI INTB# is asserted */
#define PCI_INT_SERR	0x04	/* PCI SERR# has been asserted (write one to clear) */
#define PCI_INT_PERR	0x08	/* PCI PERR# has been asserted (write one to clear) */
#define PCI_INT_PME		0x10	/* PCI PME# is asserted */
...
#define REG_RD(pDevice, OffsetName)                                         \
        INL(pDevice, &((bcmenetregs_t *)NULL)->##OffsetName)

#define REG_WR(pDevice, OffsetName, Value32)                                \
        OUTL(pDevice, &((bcmenetregs_t *)NULL)->##OffsetName, Value32)

#define REG_RD_OFFSET(pDevice, Offset)                                      \
	INL(pDevice, Offset)

#define REG_WR_OFFSET(pDevice, Offset, Value32)                             \
	OUTL(pDevice, Offset, Value32)
