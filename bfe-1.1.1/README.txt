...
A. This massage appears for Bcfine I chips when the link partner does not
   ...
   bfeN-duplex=["full"|"half"] bfeN-speed=[100|10]; # where N is a unit number

  For example
	bfe0-duplex="full" bfe0-speed=100;   # full-duplex 100Mbps for bfe0
	bfe0-duplex="half" bfe0-speed=10;    # half-duplex 10Mbps for bfe0
