...
A. This massage may appear when the link partner does not have auto
   ...
   tneN-duplex=["full"|"half"] tneN-speed=[100|10]; # where N is a unit number

  For example:
	tne0-duplex="full" tne0-speed=100;   # full-duplex 100Mbps for tne0
	tne0-duplex="half" tne0-speed=10;    # half-duplex 10Mbps for tne0
