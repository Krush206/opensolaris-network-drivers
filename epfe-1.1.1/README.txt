...
Special file name:
	/dev/epfeN (where N is an unit number, typically 0 for first card)
        For example
                % ifconfig epfe0
...
A. This massage may appear when the link partner does not have auto
  ...
  correct media mode in /kernel/drv/epfe.conf according to following syntax.
   ...
   epfeN-duplex=["full"|"half"] epfeN-speed=[100|10]; # where N is an unit number

  For example:
	epfe0-duplex="full" epfe0-speed=100;   # full-duplex 100Mbps for epfe0
	epfe0-duplex="half" epfe0-speed=10;    # half-duplex 10Mbps for epfe0
