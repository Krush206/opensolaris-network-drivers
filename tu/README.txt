...
Tu driver is ready for 64bit and 32bit solaris8 10/00 sparc or
...
(7) Using tu driver for dec 2114x chipset
If you want to use tu driver for dc2114x chipset, instead of dnet
driver, remove dnet driver before testing and/or installation.
