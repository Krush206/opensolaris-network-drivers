...
/* SCB Command Word */
#define	SC_INTMASK	0xfc00	/* individual interrupt mask (82558-) */
#define	SC_IM_CX	0x8000	/* 1: disable intr, 0:enable intr */
#define	SC_IM_FR	0x4000
#define	SC_IM_CNA	0x2000
#define	SC_IM_RNR	0x1000
#define	SC_IM_ER	0x0800
#define	SC_IM_FCP	0x0400
#define	SC_SI		0x0200	/* generate software interrupt */
#define	SC_M		0x0100	/* interrupt mask 1:mask 0: nomask */
#define	SC_CUC		0x00f0	/* CU command */
#define		SC_CUC_SHIFT	4
#define		SC_CUC_NOP	(0x0 << SC_CUC_SHIFT)
#define		SC_CUC_START	(0x1 << SC_CUC_SHIFT)
#define		SC_CUC_RESUME	(0x2 << SC_CUC_SHIFT)
#define		SC_CUC_LOADSDMP	(0x4 << SC_CUC_SHIFT)
#define		SC_CUC_SDMP	(0x5 << SC_CUC_SHIFT)
#define		SC_CUC_LOADBASE	(0x6 << SC_CUC_SHIFT)
#define		SC_CUC_SDMPRST	(0x7 << SC_CUC_SHIFT)
#define		SC_CUC_SRESUME	(0xa << SC_CUC_SHIFT)
#define	SC_RUC		0x0007	/* RU command */
#define		SC_RUC_SHIFT	0
#define		SC_RUC_NOP	(0 << SC_RUC_SHIFT)
#define		SC_RUC_START	(1 << SC_RUC_SHIFT)
#define		SC_RUC_RESUME	(2 << SC_RUC_SHIFT)
#define		SC_RUC_REDIRECT	(3 << SC_RUC_SHIFT)
...
#define	EC_EEDI	(1 << EC_EEDI_SHIFT)	/* serial data-in to eeprom */
...
#define	MC_OP_WRITE	(1 << MC_OP_SHIFT)
#define	MC_OP_READ	(2 << MC_OP_SHIFT)
#define	MC_PHYADD_SHIFT	21
#define	MC_REGADD_SHIFT	16
#define	MC_DATA	0x0000ffff
...
#define	CS_CID		0x1f000000	/* CNA interrupt delay (tcb only) */
#define		CS_CID_SHIFT	24
#define	CS_H		0x00100000
#define	CS_SF_		0x00080000	/* 0:simplify mode, 1:flexible mode */
#define	CS_OP		0x00070000
#define		CS_OP_SHIFT	16
#define	CS_C		0x00008000	/* completed */
#define	CS_OK		0x00002000	/* no error  */
#define	CS_U		0x00001000	/* underrum happened */
#define	CS_CRC		0x00000800	/* CRC error happened */
#define	CS_ALE		0x00000400	/* alignment error happened */
#define	CS_LONG		0x00000200	/* packet is too long */
#define	CS_OVERRUN	0x00000100	/* DMA overrun */
#define	CS_SHORT	0x00000080	/* runt */
#define	CS_TYPE		0x00000020	/* type:1, length:0 */
#define	CS_RXERR	0x00000010	/* error */
...
#define	TCB_TBDNUM	0xff000000
#define	TCB_TBDNUM_SHIFT	24
#define	TCB_TXTHR	0x00ff0000
#define	TCB_TXTHR_SHIFT	16
#define		TXTHR_UNIT	8
#define		TXTHR_SF	0xe0
#define	TCB_EOF		0x00008000	/* for backword compatibility */
#define	TCB_CNT		0x000003ff	/* tcb byte count */
