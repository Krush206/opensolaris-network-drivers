...
A. This massage may appear when the link partner does not have auto
  ...
  syntax:
   ...
   ganiN-duplex=["full"|"half"] ganiN-speed=[1000|100|10]; # where N is a unit number

  For example:
        gani0-duplex="full" gani0-speed=100;   # full-duplex 100Mbps for gani0
        gani0-duplex="half" gani0-speed=10;    # half-duplex 10Mbps for gani0
