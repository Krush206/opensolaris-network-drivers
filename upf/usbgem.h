...
#pragma	ident	"@(#)usbgem.h	1.2 15/11/03"
...
struct usbgem_dev {
	...
	int			tx_max_packets;
	int			tx_seq_num;
	boolean_t		tx_stopped;
	boolean_t		tx_need_to_wakeup;
...
#define		MII_ACTION_RSA		2
	...
	uint32_t	misc_flag;
#define		USBGEM_LSO_MULTIPLE_MSS_ONLY	0x10000000
#define		USBGEM_CKSUM_TCP_IPv4		0x08000000
#define		USBGEM_CKSUM_TCP_IPv4_PHCKSUM	0x04000000
#define		USBGEM_LSO_IPv4			0x02000000
#define		USBGEM_LSO_IPv4_PHCKSUM		0x01000000

#define		USBGEM_CKSUM_TCP_IPv6		0x00800000
#define		USBGEM_CKSUM_TCP_IPv6_PHCKSUM	0x00400000
#define		USBGEM_LSO_IPv6			0x00200000
#define		USBGEM_LSO_IPv6_PHCKSUM		0x00100000

#define		USBGEM_CKSUM_UDP_IPv4		0x00080000
#define		USBGEM_CKSUM_UDP_IPv4_PHCKSUM	0x00040000
#define		USBGEM_CKSUM_UDP_IPv6		0x00020000
#define		USBGEM_CKSUM_UDP_IPv6_PHCKSUM	0x00010000

#define		USBGEM_CKSUM_NOFULL_IPv4	0x00001000

#define		USBGEM_LSO			USBGEM_LSO_IPv4
#define		USBGEM_LSO_CLR_LEN_IPv4		0x00000400

#define		USBGEM_VLAN_HARD		0x00000040
#define		USBGEM_VLAN_SOFT		0x00000020
#define		USBGEM_VLAN			(USBGEM_VLAN_HARD | USBGEM_VLAN_SOFT)

#define		USBGEM_CKSUM_HEADER_IPv4	0x00000010
#define		USBGEM_CKSUM_PARTIAL		0x00000008
#define		USBGEM_CKSUM_FULL_IPv6		0x00000004
#define		USBGEM_CKSUM_FULL_IPv4		0x00000002
